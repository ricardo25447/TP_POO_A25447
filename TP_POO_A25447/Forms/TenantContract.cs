...
namespace TP_POO_A25447
{
    public partial class TenantContract : Form
    {
        ...
        static string contractsPath = Path.Combine(Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName, "TextFiles", "contracts.txt");
        ...
        private void btn_addcontract_Click(object sender, EventArgs e)
        {
            ...
            string contractsPath = Path.Combine(Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName, "TextFiles", "contracts.txt");
